...
// this code still has some of the core elements of ozone but has changed pass it.


TApplication Me =
{
        "Codename: tech7 Kernel (2024)",
        "",
        ULONG_ID(0,9,8,0),
        NULL,
        NULL,
